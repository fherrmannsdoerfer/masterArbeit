...
\begin{figure}
\subfloat[High spot density]{\includegraphics[width = 0.301\textwidth]{pictures/bundledTubesHighDensityFrameFarbig.png}}\hfill%
\subfloat[Low spot density]{\includegraphics[width = 0.30\textwidth]{pictures/bundledTubesLowDensityFrameFarbig.png}}\hfill%
\subfloat[Maximum projection]{\includegraphics[width = 0.302\textwidth]{pictures/maximumProjectionBundledTubesLSFarbig.png}}
...
\begin{figure}
\subfloat[Image before postprocessing]{\includegraphics[width = 0.32\textwidth]{pictures/postproc2.png}}\hfill
\subfloat[Mask]{\includegraphics[width = 0.32\textwidth]{pictures/postproc1.png}}\hfill	
\subfloat[Result of postprocessing]{\includegraphics[width = 0.32\textwidth]{pictures/postproc3.png}}
...
\includegraphics[width = \textwidth]{pictures/scatterplotSoftware.png}
\captionof*{figure}{high density data sets}
\end{minipage}\hfill
\begin{minipage}{0.49\textwidth}

\includegraphics[width = \textwidth]{pictures/scatterplotSoftwareLS.png}
\captionof*{figure}{low density data sets}
\end{minipage}
\captionof{figure}{Scatter plot of the mean Jaccard rank and the mean RSME rank. The correlation between high accuracy and a bad Jaccard index is clearly visible in the high density data set, however it is not present for the low density data. The closer the distance to the origin the better is the overall performance of a STORM software.}
\label{scatterSoftware}
\end{minipage}
